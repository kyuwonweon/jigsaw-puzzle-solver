"""Extract puzzle piece templates and background from images.

This module processes puzzle images to extract individual piece templates
and the background image for use in puzzle solving.
"""
...
print(f'\nBackground saved: {bg_path.name}  ({w}x{h})')
